  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var _ = function() {
      ...
      return r(t2, [{ key: "niceScale", value: function(t3, e2) {
        ...
        for (var n2 = t3; i2 >= 0; )
          o2.push(n2), n2 = x.preciseAddition(n2, s2), i2 -= 1;
    ...
    var U = function() {
      ...
      return r(t2, [{ key: "init", value: function() {
        ...
        for (var p2 = t3; p2 < a2; p2++) {
          ...
          if (d2) {
            if (s2.xaxis.min)
              for (; b2 < v2 && r2.seriesX[p2][b2] < s2.xaxis.min; b2++)
                ;
            if (s2.xaxis.max)
              for (; v2 > b2 && r2.seriesX[p2][v2] > s2.xaxis.max; v2--)
                ;
          }
    ...
    var lt = function() {
      ...
      return r(t2, [{ key: "init", value: function() {
        ...
        if (g2.height = 2 * (l2 + d2) + "px", g2.width = 2 * (l2 + d2) + "px", g2.left = h2 + "px", g2.top = c2 + "px", s2.config.legend.markers.customHTML)
          g2.background = "transparent", g2.color = a2[i2], Array.isArray(s2.config.legend.markers.customHTML) ? s2.config.legend.markers.customHTML[i2] && (r2.innerHTML = s2.config.legend.markers.customHTML[i2]()) : r2.innerHTML = s2.config.legend.markers.customHTML();
        else {
